...
public class ConfigLoader {
	...
	propertyFullscreen,
	propertyStreamStartStop,
	propertyStreamPauseUnpause,
	propertyStreamCommercial,
	propertyStreamToggleMic,
	propertyHotbar1,
	propertyHotbar2,
	propertyHotbar3,
	propertyHotbar4,
	...
	public void loadConfiguration() {
        ...
        try {       	        	      
            ...
            for (JsonObject jsonObj : props) {
        		...
        		if (jsonObj.has("stream_start_stop"))
        		currentProperty = this.propertyStreamStartStop = new KeyBindingProperty(jsonObj.get("stream_start_stop").getAsJsonObject().get("name").getAsString(), jsonObj.get("stream_start_stop").getAsJsonObject().get("category").getAsString(), jsonObj.get("stream_start_stop").getAsJsonObject().get("key_code").getAsInt(), props.indexOf(jsonObj), jsonObj.get("stream_start_stop").getAsJsonObject().get("enabled").getAsBoolean()); 
        		
        		if (jsonObj.has("stream_pause_unpause"))
        		currentProperty = this.propertyStreamPauseUnpause = new KeyBindingProperty(jsonObj.get("stream_pause_unpause").getAsJsonObject().get("name").getAsString(), jsonObj.get("stream_pause_unpause").getAsJsonObject().get("category").getAsString(), jsonObj.get("stream_pause_unpause").getAsJsonObject().get("key_code").getAsInt(), props.indexOf(jsonObj), jsonObj.get("stream_pause_unpause").getAsJsonObject().get("enabled").getAsBoolean()); 
        		
        		if (jsonObj.has("stream_commercial"))
        		currentProperty = this.propertyStreamCommercial = new KeyBindingProperty(jsonObj.get("stream_commercial").getAsJsonObject().get("name").getAsString(), jsonObj.get("stream_commercial").getAsJsonObject().get("category").getAsString(), jsonObj.get("stream_commercial").getAsJsonObject().get("key_code").getAsInt(), props.indexOf(jsonObj), jsonObj.get("stream_commercial").getAsJsonObject().get("enabled").getAsBoolean()); 
        		
        		if (jsonObj.has("stream_toggle_mic"))
        		currentProperty = this.propertyStreamToggleMic = new KeyBindingProperty(jsonObj.get("stream_toggle_mic").getAsJsonObject().get("name").getAsString(), jsonObj.get("stream_toggle_mic").getAsJsonObject().get("category").getAsString(), jsonObj.get("stream_toggle_mic").getAsJsonObject().get("key_code").getAsInt(), props.indexOf(jsonObj), jsonObj.get("stream_toggle_mic").getAsJsonObject().get("enabled").getAsBoolean()); 
                ...
                if (jsonObj.has("disable_shader"))
                currentProperty = this.propertyDisableShader = new KeyBindingProperty(jsonObj.get("disable_shader").getAsJsonObject().get("name").getAsString(), jsonObj.get("disable_shader").getAsJsonObject().get("category").getAsString(), jsonObj.get("disable_shader").getAsJsonObject().get("key_code").getAsInt(), props.indexOf(jsonObj), jsonObj.get("disable_shader").getAsJsonObject().get("enabled").getAsBoolean()); 
