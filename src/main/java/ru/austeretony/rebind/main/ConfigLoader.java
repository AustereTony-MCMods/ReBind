...
public class ConfigLoader {
	...
	categoryFullscreen,
	categoryStreamStartStop,
	categoryStreamPauseUnpause,
	categoryStreamCommercial,
	categoryStreamToggleMic,
	categoryHotbar1,
	categoryHotbar2,
	categoryHotbar3,
	categoryHotbar4,
	...
	keyCodeSmoothCamera,
	keyCodeFullscreen,
	keyCodeStreamStartStop,
	keyCodeStreamPauseUnpause,
	keyCodeStreamCommercial,
	keyCodeStreamToggleMic,
	keyCodeHotbar1,
	keyCodeHotbar2,
	keyCodeHotbar3,
	keyCodeHotbar4,
	...
	enableSmoothCamera,
	enableFullscreen,
	enableStreamStartStop,
	enableStreamPauseUnpause,
	enableStreamCommercial,
	enableStreamToggleMic,
	enableHotbar1,
	enableHotbar2,
	enableHotbar3,
	enableHotbar4,
	...
	public void loadConfiguration() {
        ...
        try {
            ...
            categoryStreamStartStop = configFile.get("stream_start_stop").getAsJsonObject().get("category").getAsString();
            keyCodeStreamStartStop = configFile.get("stream_start_stop").getAsJsonObject().get("key_code").getAsInt();
            enableStreamStartStop = configFile.get("stream_start_stop").getAsJsonObject().get("enabled").getAsBoolean();
            
            categoryStreamPauseUnpause = configFile.get("stream_pause_unpause").getAsJsonObject().get("category").getAsString();
            keyCodeStreamPauseUnpause = configFile.get("stream_pause_unpause").getAsJsonObject().get("key_code").getAsInt();
            enableStreamPauseUnpause = configFile.get("stream_pause_unpause").getAsJsonObject().get("enabled").getAsBoolean();
            
            categoryStreamCommercial = configFile.get("stream_commercial").getAsJsonObject().get("category").getAsString();
            keyCodeStreamCommercial = configFile.get("stream_commercial").getAsJsonObject().get("key_code").getAsInt();
            enableStreamCommercial = configFile.get("stream_commercial").getAsJsonObject().get("enabled").getAsBoolean();
            
            categoryStreamToggleMic = configFile.get("stream_toggle_mic").getAsJsonObject().get("category").getAsString();
            keyCodeStreamToggleMic = configFile.get("stream_toggle_mic").getAsJsonObject().get("key_code").getAsInt();
            enableStreamToggleMic = configFile.get("stream_toggle_mic").getAsJsonObject().get("enabled").getAsBoolean();
            ...
            categoryDisableShader = configFile.get("disable_shader").getAsJsonObject().get("category").getAsString();
            keyCodeDisableShader = configFile.get("disable_shader").getAsJsonObject().get("key_code").getAsInt();
            enableDisableShader = configFile.get("disable_shader").getAsJsonObject().get("enabled").getAsBoolean();
